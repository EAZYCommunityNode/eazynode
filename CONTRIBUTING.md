Contributing to EZY Core
==================================

The EZY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EZY Core project, and is not to be
confused with overall EZY Network Protocol consensus changes.

Whether a pull request is merged into EZY Core rests with the project merge
...
Patches that change EZY consensus rules are considerably more involved than
...
Where a patch set proposes to change the EZY consensus, it must have been
...
The project leader is the release manager for each EZY Core release.
