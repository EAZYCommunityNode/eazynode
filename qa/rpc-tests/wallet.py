...
#   c) node1 mines 32 blocks, so now node 0 has 500000EZY, node 1 has 4250EZY, node2 has none.
#   d) node0 sends 601 EZY to node2, in two transactions (301 EZY, then 300 EZY).
