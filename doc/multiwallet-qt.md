...
In order to support loading of multiple wallets in ezy-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ezy.cpp.
...
Changes to ezy.cpp
----------------------
ezy.cpp is the entry point into ezy-qt, and as such, will require some minor modifications to provide hooks for
