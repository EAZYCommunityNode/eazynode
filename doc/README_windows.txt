...
Intro
-----
EZY (EZY) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. EZY utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run ezy-qt.exe.

EZY Core is the original EZY client and it builds the backbone of the network.
However, it downloads and stores the entire history of EZY transactions;
