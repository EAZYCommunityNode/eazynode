                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EZY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CLG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and collegicoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EZY Core"), this);
    aboutAction->setStatusTip(tr("Show information about EZY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EZY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EZY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EZY addresses"));
    ...
    openAction->setStatusTip(tr("Open a ezy: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EZY Core help message to get a list with possible EZY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EZY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EZY network", "", count));
}
...
{
    QString strTitle = tr("EZY Core"); // default title
