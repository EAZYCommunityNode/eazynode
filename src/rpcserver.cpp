...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EZY features */
        {"ezy", "masternode", &masternode, true, true, false},
        {"ezy", "listmasternodes", &listmasternodes, true, true, false},
        {"ezy", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ezy", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ezy", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ezy", "masternodedebug", &masternodedebug, true, true, false},
        {"ezy", "startmasternode", &startmasternode, true, true, false},
        {"ezy", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ezy", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ezy", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ezy", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ezy", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ezy", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ezy", "mnbudget", &mnbudget, true, true, false},
        {"ezy", "preparebudget", &preparebudget, true, true, false},
        {"ezy", "submitbudget", &submitbudget, true, true, false},
        {"ezy", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ezy", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ezy", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ezy", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ezy", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ezy", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ezy", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ezy", "checkbudgets", &checkbudgets, true, true, false},
        {"ezy", "mnsync", &mnsync, true, true, false},
        {"ezy", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> ezy-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:52321/\n";
}
